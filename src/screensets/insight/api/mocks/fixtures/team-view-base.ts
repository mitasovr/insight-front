...
export const TEAM_MEMBERS_MONTH: TeamMember[] = [
  ...
  { person_id: 'p3',  period: 'month', name: 'Tom Sullivan', seniority: 'Middle', tasks_closed: 3,  bugs_fixed: 2, dev_time_h: 26, prs_merged: 3,  build_success_pct: 83, focus_time_pct: 55, ai_tools: ['Codex'],                  ai_loc_share_pct: 8  },
  ...
  { person_id: 'p9',  period: 'month', name: 'James Wilson', seniority: 'Junior', tasks_closed: 4,  bugs_fixed: 2, dev_time_h: 20, prs_merged: 3,  build_success_pct: 82, focus_time_pct: 42, ai_tools: [],                        ai_loc_share_pct: 0  },
  ...
  { person_id: 'p12', period: 'month', name: 'Nina Ross',    seniority: 'Junior', tasks_closed: 3,  bugs_fixed: 1, dev_time_h: 22, prs_merged: 2,  build_success_pct: 79, focus_time_pct: 53, ai_tools: ['Cursor'],                 ai_loc_share_pct: 10 },
];
