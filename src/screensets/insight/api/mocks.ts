...
const BULLET_SECTIONS_MONTH: BulletSection[] = [
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        sublabel: 'Jira · time in In Progress state · lower = better', value: '14h', unit: 'h',
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        sublabel: 'Bitbucket · PR opened → merged · lower = better', value: '18h', unit: 'h',
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        sublabel: 'Jira · days past due date · lower = better', value: '2.1d', unit: 'd',
...
const ALICE_BULLET_METRICS_MONTH: BulletMetric[] = [
  ...
  { period: 'month', section: 'task_delivery', metric_key: 'task_dev_time', label: 'Task Development Time', sublabel: 'Jira · time in In Progress state · lower = better', value: '14h', unit: 'h', range_min: '8h', range_max: '31h', median: '15', median_label: 'Median: 15h', bar_left_pct: 0, bar_width_pct: 43, median_left_pct: 48, status: 'good', drill_id: 'cycle-time' },
  ...
  { period: 'month', section: 'collab', metric_key: 'meeting_hours', label: 'Meeting Hours', sublabel: 'Zoom · meeting duration + M365 audioDuration · lower = more focus time', value: '12h', unit: 'h/mo', range_min: '4h', range_max: '28h', median: '16', median_label: 'Median: 16h', bar_left_pct: 0, bar_width_pct: 33, median_left_pct: 50, status: 'good', drill_id: '' },
...
function generateIcDashboard(baseMember: TeamMember, period: PeriodValue): IcDashboardData {
  ...
  const bulletMetrics: BulletMetric[] = [
    ...
    bm(period, 'task_delivery', 'task_dev_time', 'Task Development Time', 'Jira · time in In Progress state · lower = better',
      `${m.dev_time_h}h`, 'h', '8h', '31h', '15', 'Median: 15h',
    ...
    bm(period, 'task_delivery', 'due_date_compliance', 'Due Date Compliance', 'Jira · tasks closed by due date',
      `${Math.min(100, Math.round(60 + build / 4))}%`, '%', '40%', '100%', '72', 'Median: 72%',
    ...
    bm(period, 'code_quality', 'pr_cycle_time', 'PR Cycle Time', 'Bitbucket · PR opened → merged · lower = better',
      `${m.dev_time_h}h`, 'h', '0h', '72h', '24', 'Median: 24h',
